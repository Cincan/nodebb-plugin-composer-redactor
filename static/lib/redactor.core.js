...
define('redactor', [
   ...
   // $.Redactor.opts.plugins = ['video', 'table', 'topic_thumb', 'underline', 'emoticons', 'iconic'];
	//$.Redactor.opts.plugins = ['video','table', 'topic_thumb', 'emoticons', 'iconic'];
	if (utils.isMobile()) {
		//$.Redactor.opts.buttons.splice($.Redactor.opts.buttons.indexOf('lists'), 1, 'horizontalrule', 'ol', 'ul');
		$.Redactor.opts.buttons.splice($.Redactor.opts.buttons.indexOf('lists'),1);
		$.Redactor.opts.plugins = ['topic_thumb', 'emoticons', 'iconic'];
	}else{
