...
(function($)
{
	...
	let showButton = [];
	if (utils.isMobile()) {
		showButton = ['format', 'bold', 'image', 'file'];

	} else {
		showButton = ['format', 'bold', 'italic', 'underline', 'deleted', 'lists', 'image', 'file', 'link']
	...
	$.Redactor.opts = {
		...
		//buttons: showButton,
		//buttons: [],
		buttons: ['format', 'bold','italic', 'underline', 'deleted', 'lists', 'image', 'file', 'link'],
		// buttons: ['format', 'bold', 'italic', 'underline', 'deleted', 'lists', 'image', 'file', 'link', 'horizontalrule'], // + 'horizontalrule', 'underline', 'ol', 'ul', 'indent', 'outdent'
        buttonsTextLabeled: false,
		buttonsHide: [],
		buttonsHideOnMobile: ['format', 'bold', 'italic', 'underline', 'deleted', 'lists','file', 'link'],
